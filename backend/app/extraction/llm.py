...
free of any direct dependency on the `anthropic` SDK or app.ai internals."""
...
def llm_extract(html: str, url: str) -> ExtractedProduct | None:
    from ..ai.extract import llm_extract_product  # lazy: don't import anthropic unless used
