...
const TERMS: Doc = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        "Submit a URL you do not have the right to have fetched on your behalf, or one intended to probe internal or private network addresses.",
        "Scrape, crawl, copy, or harvest data from the Service, or resell or redistribute its content.",
        "Use bots, scripts, or other automated means to access the Service or circumvent rate limits, including the per-account limit on tracked products.",
    ...
    },
    {
      ...
      body: [
        "The Service does not provide financial, legal, tax, or professional purchasing advice. Deal scores, price statistics, and AI-generated verdicts are provided for general informational purposes and should not be relied upon as the sole basis for any purchase decision.",
      ],
    },
    {
      h: "Donations",
    ...
    },
    {
      h: "Disclaimers",
      body: [
        "THE SERVICE IS PROVIDED “AS IS” AND “AS AVAILABLE,” WITHOUT WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, ACCURACY, AND NON-INFRINGEMENT. We do not warrant that the Service will be uninterrupted, error-free, or that any price, deal score, or verdict is accurate or available.",
      ],
    },
    {
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        "Tracking information — the product URLs you submit, the price history and alert rules associated with them, and your alert history.",
        "Technical information — IP address, browser and device type, and server log data, used for security and diagnostics.",
        "Cookies — a signed, httpOnly session cookie keeps you signed in; a non-sensitive cookie backs a CSRF check; local storage holds a guest-mode flag.",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Fetch and re-check the product pages you ask us to track, and send the price-drop alerts you've configured.",
    ...
    },
    {
      ...
      body: [
        "We use a signed session cookie to keep you signed in and local storage to remember a guest-mode flag. We do not use third-party advertising or cross-site tracking cookies. You can clear this data at any time through your browser settings, though doing so will sign you out.",
      ],
    },
    {
      h: "Third-Party Services",
      body: [
        "We rely on a small number of third-party providers to operate the Service, including Stripe for donation processing, Anthropic's Claude API for product-page extraction and price-analysis text, an email provider for price-drop alerts, and hosting and infrastructure providers. Product data is fetched from the third-party page you submit at the time you submit it and on scheduled rechecks thereafter. These third parties process information under their own privacy policies.",
      ],
    },
    {
